...
target_tables = json.loads(Variable.get("full_pattern_tables_r"))
...
hive_warehouse = abspath(f"hdfs://{hive_metastore_conn.host}/user/uariflow/warehouse/")
...
#mssql_server= f"{mssql_server_2016_conn.host}:{mssql_server_2016_conn.port}"
