...
target_tables = json.loads(Variable.get("yyyymm_pattern_tables"))
...
hive_warehouse = abspath(f"hdfs://{hive_metastore_conn.host}/user/uairlow/warehouse/")
